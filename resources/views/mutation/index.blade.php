                    ...
                    <div class="modal-content">
                        ...
                        <form id="customer_form">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="location">Lokasi Awal</label>
                                    <select name="location" id="location-awal-select2" class="form-select select2" style="width: 100%;">
                                ...
                                <div class="form-group">
                                    <label for="location">Lokasi Akhir</label>
                                    <select name="location" id="location-akhir-select2" class="form-select select2" style="width: 100%;">
                                        <option value="" disabled selected>Select a location</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    <label for="location">Product</label>
                                    <select name="location" id="location-akhir-select2" class="form-select select2" style="width: 100%;">
                                        <option value="" disabled selected>Select a location</option>
                                    </select>
                                    <small id="error_lokasi_akhir" class="form-text text-danger">We'll never share your email with anyone else.</small>
                                ...
                                <div class="form-group">
                                    <label for="location">Jenis</label>
                                    <select name="location" id="location-akhir-select2" class="form-select select2" style="width: 100%;">
                                ...
                                <div class="form-group">
                                    <label for="location">Pegawai</label>
                                    <select name="location" id="location-akhir-select2" class="form-select select2" style="width: 100%;">
                                        <option value="" disabled selected>Select a jenis</option>
                                    </select>
                                    <small id="error_lokasi_akhir" class="form-text text-danger">We'll never share your email with anyone else.</small>
